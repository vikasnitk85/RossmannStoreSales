...
tuneGrid <- expand.grid(Seed=c(8, 1:7, 9:50), gamma=0, max_depth=4, min_child_weight=1,
                        subsample=0.3, colsample_bytree=1, lambda=0, alpha=1)
